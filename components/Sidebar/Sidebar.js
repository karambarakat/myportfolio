          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              <li className="items-center">
                ...
                >
                  <i className={'fas fa-tv mr-2 text-sm ' + (router.pathname.indexOf('/admin/dashboard') !== -1 ? 'opacity-75' : 'text-blueGray-300')}></i>{' '}
                  Dashboard
                </Link>
              </li>
              ...
              <li className="items-center">
                ...
                >
                  <i className={'fas fa-tools mr-2 text-sm ' + (router.pathname.indexOf('/admin/settings') !== -1 ? 'opacity-75' : 'text-blueGray-300')}></i>{' '}
                  Settings
                </Link>
              </li>
              ...
              <li className="items-center">
                ...
                >
                  <i className={'fas fa-table mr-2 text-sm ' + (router.pathname.indexOf('/admin/tables') !== -1 ? 'opacity-75' : 'text-blueGray-300')}></i>{' '}
                  Tables
                </Link>
              </li>
              ...
              <li className="items-center">
                ...
                >
                  <i className={'fas fa-map-marked mr-2 text-sm ' + (router.pathname.indexOf('/admin/maps') !== -1 ? 'opacity-75' : 'text-blueGray-300')}></i>{' '}
                  Maps
                </Link>
              </li>
            </ul>
